document.getElementById('login-button').addEventListener('click', async function () {
  ...
  if (username === 'ambulatorio' && password === 'ambulatorio') {
    ...
    window.location.href = "https://app.powerbi.com/view?r=eyJrIjoiZTEzZTZkNjUtMjgwNy00YTcxLWE5ODMtNWU0YzIzYTA2N2M5IiwidCI6IjNhNzhiMGNkLTdjOGUtNDkyOS08M2Q1LTE5MGE2Y2MwMTM2NSJ9";
  } else {
